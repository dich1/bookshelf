    ...
    if (books.length > 0) {
        books.forEach(function (book) {
            ...
            var bookItemElement = '<div id="' + id + '" class="book_item">'
                                ...
                                + '<div class="book_status ' + reading + '"><input type="button" name="book_reading" value="読書中" onclick="openDatepicker(' + id + ');"></div>'
                                + '<div class="book_status ' + safekeeping + '"><input type="button" name="book_safekeeping" value="読書済" onclick="updateBookSafekeeping(' + id + ');updateReturnDate(' + id + ', &#39;&#39;)"></div>'
                                + '</form>'
